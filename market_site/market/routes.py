...
@market.route('/auction/<int:auction_id>', methods=['GET', 'POST'])
@login_required
...
@market.route('/auction/<int:auction_id>/join', methods=['GET', 'POST'])
@login_required
...
@market.route('/auction/<int:auction_id>/history', methods=['GET', 'POST'])
@login_required
